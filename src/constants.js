...
export const SERVICE_SPIMM_CATEGORY_EMOC = "EmOC";
export const SERVICE_SPIMM_CATEGORY_ECC = "ECC";
export const SERVICE_SPIMM_CATEGORY_ADD_ON = "Add On";
export const SERVICE_SPIMM_CATEGORIES = [
  SERVICE_SPIMM_CATEGORY_EMOC,
  SERVICE_SPIMM_CATEGORY_ECC,
  SERVICE_SPIMM_CATEGORY_ADD_ON
];
